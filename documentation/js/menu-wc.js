...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">tarea-duoc documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/ProfileModalComponent.html" data-type="entity-link" >ProfileModalComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/RegisterModalComponent.html" data-type="entity-link" >RegisterModalComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/SegmentoModalComponent.html" data-type="entity-link" >SegmentoModalComponent</a>
                            </li>
                            <li class="link">
